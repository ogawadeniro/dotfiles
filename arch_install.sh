...
create_link "$HOME/.dotfiles/fastfetch" "$HOME/.config/fastfetch"
create_link "$HOME/.dotfiles/wlogout" "$HOME/.config/wlogout"
create_link "$HOME/.dotfiles/swaync" "$HOME/.config/swaync"
create_link "$HOME/.dotfiles/git/.gitconfig" "$HOME/.gitconfig"
create_link "$HOME/.dotfiles/git/.git_commit_template" "$HOME/.git_commit_template"
